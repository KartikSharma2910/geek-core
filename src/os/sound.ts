...
export const sfx = {
  ...
  open: () => { tone(520, 0.06); setTimeout(() => tone(820, 0.07), 50); },
  close: () => { tone(700, 0.05); setTimeout(() => tone(380, 0.07), 40); },
  boot: () => {
    [220, 330, 440, 660, 880].forEach((f, i) => setTimeout(() => tone(f, 0.12, "sawtooth", 0.05), i * 110));
  },
  achievement: () => {
