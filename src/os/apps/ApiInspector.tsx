    ...
    <div className="p-3 space-y-3 text-xs">
      <div className="flex gap-2">
        <select
          ...
          className="bg-black/50 neon-border rounded px-2 py-1"
        >
        ...
        <input
          ...
          className="flex-1 bg-black/50 neon-border rounded px-2 py-1 font-mono"
        />
        <button
          onClick={send}
          disabled={loading}
          className="px-3 py-1 neon-border rounded hover:bg-[var(--neon)]/15 neon-text disabled:opacity-50"
        >
          {loading ? "..." : "SEND"}
        </button>
      </div>
