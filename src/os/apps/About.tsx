  ...
  return (
    <div className="p-6 space-y-3 text-sm">
      ...
      <p className="opacity-80">
        A browser-based, fictional operating system inspired by hacker culture and cyberpunk dev
        environments.
      </p>
      ...
      <p className="text-[10px] opacity-50 pt-3">
        All "scans", "exploits" and "networks" are simulated for educational purposes only.
      </p>
    </div>
  );
}
